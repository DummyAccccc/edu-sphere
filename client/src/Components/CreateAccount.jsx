    ...
    return (
        <>
            {user ? <div className='w-full flex items-center justify-center'>
                <div className='w-3/4 md:w-1/2 flex flex-col gap-y-8 px-8 py-8 bg-slate-800 rounded-lg mb-10'>
                ...
                <div className='w-3/4 md:w-1/2 flex flex-col gap-y-8 px-8 py-8 bg-slate-800 rounded-lg'>
                    ...
                    <form className='text-xl' onSubmit={RoleSubmitHandler}>
                        ...
                        <div className='w-full my-6 flex flex-col lg:flex-row gap-3 justify-between items-center'>
                            <button className='w-full py-6 bg-slate-600 hover:bg-slate-700 p-3 rounded-md text-white text-md md:text-xl' value="Administrator" onClick={(e) => setUser(e.target.value)}>Administrator</button>
                            <button className='w-full py-6 bg-slate-600 hover:bg-slate-700 p-3 rounded-md text-white text-md md:text-xl' value="Instructor" onClick={(e) => setUser(e.target.value)}>Instructor</button>
                            <button className='w-full py-6 bg-slate-600 hover:bg-slate-700 p-3 rounded-md text-white text-md md:text-xl' value="Student" onClick={(e) => setUser(e.target.value)}>Student</button>
                        </div>
                    </form>
                </div>
            </div>}
