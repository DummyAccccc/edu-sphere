    ...
    <>
      <nav className="bg-white shadow-md">
        <div className="container flex justify-around items-center p-4 mx-auto">
          <h1 className="text-blue-700 text-lg font-bold">Edu-Sphere</h1>
          <div className="flex items-center">
            ...
            <Link to="/signin"><button className=" bg-orange-500 text-white px-4 py-2 rounded-md hidden md:block">Get Started Free</button></Link>
